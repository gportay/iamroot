...
- Intercept the [FreeBSD]'s functions `exect`, `execvP()` and `mount()`
...
[unreleased]: https://github.com/gportay/iamroot/compare/v5...master
...
[v5]: https://github.com/gportay/iamroot/compare/v5...v5
