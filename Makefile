...
IAMROOT_LIB_LINUX_RISCV64_LP64D_1 = $(IAMROOT_LIB)
export IAMROOT_LIB_LINUX_RISCV64_LP64D_1
...
IAMROOT_LIB_MUSL_RISCV64_1 = $(IAMROOT_LIB)
export IAMROOT_LIB_MUSL_RISCV64_1

IAMROOT_LIB_ELF_1 = $(IAMROOT_LIB)
export IAMROOT_LIB_ELF_1

IAMROOT_PATH_RESOLUTION_AF_UNIX = /tmp
export IAMROOT_PATH_RESOLUTION_AF_UNIX
