...
ssize_t next_extattr_get_fd(int fd, int attrnamespace, const char *attrname,
			    void *data, size_t nbytes)
{
	ssize_t (*sym)(int, int, const char *, void *, size_t);
	ssize_t ret;
		       ...
		       void *data, size_t nbytes)
{
	...
	return next_extattr_get_fd(fd, attrnamespace, attrname, data, nbytes);
}
#endif
