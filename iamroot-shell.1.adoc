...
Create a new Arch Linux system installation from scratch via *pacstrap(8)*
	...
	gpg: revocation certificate stored as '/home/gportay/rootfs/etc/pacman.d/gnupg/openpgp-revocs.d/7484186E876B632498A6B12E5CA22B2044E718A1.rev'
	gpg: Done
	...
	gpg: next trustdb check due at 2022-07-18
